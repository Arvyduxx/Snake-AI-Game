...
# Score label
score_label = tk.Label(root, text="Score: 0", font=("Arial", 14), fg="white")
score_label.pack()

# High Score label
high_score_label = tk.Label(root, text="High Score: 0", font=("Arial", 14), fg="white")
...
classic_button = tk.Button(root, text="Classic Mode", font=("Arial", 12), command=lambda: set_mode("Classic"))
classic_button.pack()

unlimited_button = tk.Button(root, text="Unlimited Mode", font=("Arial", 12), command=lambda: set_mode("Unlimited"))
unlimited_button.pack()

hard_button = tk.Button(root, text="Hard Mode", font=("Arial", 12), command=lambda: set_mode("Hard"))
hard_button.pack()
